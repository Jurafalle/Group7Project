...
<title>Waffles College Student Portal Login</title>
</head>
<body>
...
<h3>Waffles College Student Portal Login</h3>
...
<div class="col-container">
  <nav>
       ...
       <a href="../main/MainPage.jsp" class="sidebar-button"><b>Back</b></a>
  </nav>
  
  <article>
    <h1>Student Login</h1>
    <p>Login codes go here.</p>
