...
<div class="col-container">
  <nav>
       <a href="lecturerviewcoursestaught.jsp" class="sidebar-button">View Courses Taught</a>
       <a href="lecturerviewcourseenrolment.jsp" class="sidebar-button">View Course Enrolment</a>
       <a href="lecturergradeacourse.jsp" class="sidebar-button">Grade a Course</a>
       <a href="lecturerviewastudentperformance.jsp" class="sidebar-button"><b>View a Student Performance</b></a>
       <a href="mainpage.jsp" class="sidebar-button">Log Out</a>
  </nav>
  
  <article>
    <h1>View A Student Performance</h1>
    <p>Codes go here.</p>
