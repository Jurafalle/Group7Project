...
<div class="col-container">
  <nav>
       ...
       <a href="lecturerviewcourseenrolment.jsp" class="sidebar-button"><b>View Course Enrolment</b></a>
       <a href="lecturergradeacourse.jsp" class="sidebar-button">Grade a Course</a>
       <a href="lecturerviewastudentperformance.jsp" class="sidebar-button">View a Student Performance</a>
       <a href="mainpage.jsp" class="sidebar-button">Log Out</a>
  </nav>
  
  <article>
    <h1>View Course Enrolment</h1>
    <p>Codes go here.</p>
